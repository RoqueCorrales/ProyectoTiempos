...
namespace ProyectoTiempos.Modelo
{
    class SorteoPremiado : ErrorHandler
    {
        ...
        public void Insert( string codigo_sorteo,int numUno,int numDos,int numTres, int id_sorteo)
        {
            ...
            DataTable result = Program.da.SqlQuery("insert into numPremiados (numerouno, numerodos, numerotres, id_sorteo, codigo_sorteo ) values (@numerouno, @numerodos, @numerotres, @id_sorteo, @codigo_sorteo ) returning id;", parametros);
